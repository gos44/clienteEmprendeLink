...
// Cambiar de:
Route::put('/perfil/editar/{id}', [PerfilInverEditarController::class, 'update'])
    ->name('perfilInver.update');

// A:
Route::put('/perfil/editar', [PerfilInverEditarController::class, 'update'])
    ->name('perfilInver.update');
