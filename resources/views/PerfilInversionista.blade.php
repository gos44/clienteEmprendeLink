...
<head>
    ...
    <link rel="stylesheet" href="http://localHost/clienteEmprendeLink/resources/css/perfilInversionista.css">
...
<body>
  ...
  <main class="profile-container">
    ...
    <div class="profile-info">
        ...
        <div class="info-group">
            <label><i class="fas fa-book"></i> Certificado:</label>
            <input type="text" value="CertificadoExperiencia.pdf" readonly>
        </div>

        <div class="info-group">
          <label><i class="fas fa-book"></i> Experiencia:</label>
          <input type="text" value="CredencialesFinacieras.pdf" readonly>
      </div>
...
<script src="http://localHost/clienteEmprendeLink/resources/js/footerInversionista.js"></script>
<script src="http://localHost/clienteEmprendeLink/resources/js/profile.js"></script>
