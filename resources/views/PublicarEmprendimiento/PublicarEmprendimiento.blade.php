...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/PublicarEmprendimiento.css')}}"> 
</head>
<body>
  <div id="header"></div>
  <script>
    // Cargar el contenido del navbar
    fetch('navbarUsuario.blade.php')
...
<div class="container">
    ...
    <a href="publicarEmprendimiento parte 2.html" class="btn-publicar">Siguiente</a>
</div>
...
<footer>
  <div class="footer-content">
      ...
      <div class="footer-section links">
          <h3>Legales</h3>
          <ul>                    <li><a href="sobreEmpredelink.html">Sobre Emprende Link</a></li>
