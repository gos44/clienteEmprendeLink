...
<head>
    ...
    <script src="Scrips/inicio_secion_inver.js"></script>
</head>
<body>
    <form class="form">
        ...
        <div class="inputForm">
            ...
            <input type="text" class="input"  placeholder="Ingrese su usuario" id="usuario" />
        </div>
        ...
        <div class="inputForm">
            ...
            <input type="password" class="input" placeholder="Ingrese su contraseña" id="contraseña" />
        </div>
        ...
        <p class="p">¿No tienes una cuenta? <a href="registro_inver1.html" class="span">Regístrate</a></p>
        ...
        <div class="flex-row">
            ...
            <button id="facebook-btn" class="btn facebook">
    ...
    //     if(user== "dayroncamilo" && pass=="mona"){

    //       window.location="bienbenido a Emprende Link ";
