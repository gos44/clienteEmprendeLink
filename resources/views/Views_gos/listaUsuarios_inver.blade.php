        ...
        <section class="notifications">
            ...
            <div class="notification">
                ...
                <div class="notification-content">
                  <h3><a href="{{ route('VerInver.index') }}">Miguel Angel Bonilla</a></h3>
                  <p><strong>Correo:</strong> miguel@example.com</p>
                  <p><strong>Ubicación:</strong> Popayán, Colombia</p>
                </div>
               <a href="{{ route('Chat_Inversor.index') }}"> <button class="send-message"><i class="fas fa-envelope"></i> Enviar mensaje</button></a>
            </div>
            <div class="notification">  
