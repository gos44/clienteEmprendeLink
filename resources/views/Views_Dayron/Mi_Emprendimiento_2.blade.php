  ...
  <div class="main-content">
    <section class="hero">
      <div class="hero-background">
          <img src="images/arepa_fondo.png" alt="Mercado de Vinos">
      </div>
      <div class="hero-overlay"></div>
      <div class="hero-content">
          <div class="hero-main">
              <img src="images/arepas.png" alt="Mercado de Vinos Logo" class="hero-logo">
    ...
    <section class="profile">
      ...
      <div class="content">
          <section class="products">
              <div class="product">
                  <img src="images/arepa.png" alt="Vino tinto Malbec argentino">
                  <div class="product-info">
                      <h4>Arepa de maíz</h4>
                      <p>Sumérgete en una explosión de sabores...</p>
                  </div>
              </div>
              <div class="product">
                  <img src="images/AREPA2.jpg" alt="Vino rosado Pinot Noir de Francia">
                  <div class="product-info">
                      <h4>Arepa de carne</h4>
                      <p>Eleva tus sentidos con la complejidad...</p>
                  </div>
              </div>
              <div class="product">
                  <img src="images/AREPA3.jpg" alt="Vino espumoso Brut Cava">
                  <div class="product-info">
                      <h4>Arepa de queso</h4>
                      <p>Disfruta de esta increible arepa con mucho queso...</p>
                  </div>
              </div>
              <div class="product">
                  <img src="images/AREPA5.jpg" alt="Vino rosado">
                  <div class="product-info">
                      <h4>Arepa mixta de pollo</h4>
                      <p>Disfruta de la frescura y la elegancia de esta arepa...</p>
                  </div>
              </div>
          </section>
